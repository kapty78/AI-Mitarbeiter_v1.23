          ...
          <>
            <div className="relative mb-6">
              <div 
                ...
                className="flex cursor-pointer items-center justify-between rounded-lg border border-[#444444] bg-[#242424] px-4 py-3 hover:border-pink-600/50 hover:bg-[#2a2a2a]"
              >
                  ...
                  <div className="p-3">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full rounded-lg border border-[#333333] bg-[#1e1e1e] py-2 pl-10 pr-3 text-sm text-white placeholder:text-gray-500 focus:border-pink-600 focus:outline-none"
                      />
                    </div>
                  </div>
